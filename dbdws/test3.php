...
echo $xml_data='<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ser="http://service.wsdata.dbd.gov/">
   <soapenv:Header/>
   <soapenv:Body>
...
echo $URL = "https://dbdwsgw.dbd.go.th/dbdwsservice/ImagesService";
