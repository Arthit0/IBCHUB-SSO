$(document).ready(function () {
    $(`#form_reg_company [name="contact_province_old"]`).hide();
    $(`#form_reg_company [name="contact_district_old"]`).hide();
    $(`#form_reg_company [name="contact_subdistrict_old"]`).hide();
    $(`#form_reg_company [name="contact_address_old"]`).hide();
    $(`#form_reg_company [name="contact_postcode_old"]`).hide();
    $(`#form_reg_company [name="state"]`).val('new');
    ...
    $.ajax({
        ...
        success: function (result) {
            $.each(result, function (key, value) {
                ...
                if (result.lang === 'th') {
                    $(`#form_reg_company [name^="contact_province"]`).append(`<option value="${value.id}">${value.name_th}</option>`);
                    $(`#form_reg_noncompany [name^="contact_province"]`).append(`<option value="${value.id}">${value.name_th}</option>`);
                    $(`#form_reg_noncompany [name^="companyTH_province"]`).append(`<option value="${value.id}">${value.name_th}</option>`);
                } else {
                    $(`#form_reg_company [name^="contact_province"]`).append(`<option value="${value.id}">${value.name_en}</option>`);
                    $(`#form_reg_noncompany [name^="contact_province"]`).append(`<option value="${value.id}">${value.name_en}</option>`);
                    $(`#form_reg_noncompany [name^="companyTH_province"]`).append(`<option value="${value.id}">${value.name_en}</option>`);
                }
            });
...
const change_district =(obj)=>{
    $(`#form_reg_company [name^="contact_subdistrict"]`).find('option').remove();
    // $(`#form_reg_company [name^="contact_subdistrict"]`).html(`<option value="">กรุณาเลือกอำเภอ</option>`);
    $('.selectpicker').selectpicker('refresh');
    $(`#form_reg_company [name^="contact_postcode"]`).val('');
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (key, value) {
                ...
                if (result.lang == 'th') {
                    $(`#form_reg_company [name^="contact_subdistrict"]`).append(`<option value="${value.id}">${value.name_th}</option>`);
                } else {
                    $(`#form_reg_company [name^="contact_subdistrict"]`).append(`<option value="${value.id}">${value.name_en}</option>`);
                }
            });
            $('.selectpicker').selectpicker('refresh');

            let select_subdistrict = $("#form_reg_company [name='contact_subdistrict']").val();
            let option_subdistrict = $("#form_reg_company [name='contact_subdistrict]'] option");
...
const change_province = (obj) => {
    $(`#form_reg_company [name="contact_district"]`).find('option').remove();
    $(`#form_reg_company [name="contact_subdistrict"]`).find('option').remove();
    $(`#form_reg_company [name="contact_postcode"]`).val('');
    ...
    $.ajax({
        ...
        success: function (result) {
            $.each(result, function (key, value) {
                ...
                if (result.lang == 'th') {
                    $(`#form_reg_company [name^="contact_district"]`).append(`<option value="${value.id}">${value.name_th}</option>`);
                } else {
                    $(`#form_reg_company [name^="contact_district"]`).append(`<option value="${value.id}">${value.name_en}</option>`);
                }
            });
            $('.selectpicker').selectpicker('refresh');

            let select_district = $("#form_reg_company [name='contact_district']").val();
            let option_district = $("#form_reg_company [name='contact_district'] option");
...
const change_province2 = (obj) => {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            // store data option to sub_districe
            change_district2($(`[name^="contact_district"]`))
        },
        complete: function() {
            $('.modal-spin').modal('hide');
        }
...
const change_district3 =(obj)=>{
    ...
    $('.selectpicker').selectpicker('refresh');
    $(`#form_reg_noncompany [name^="companyTH_province"]`).val('');
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (key, value) {
                ...
                if (result.lang == 'th') {
                    $(`#form_reg_noncompany [name^="companyTH_subdistricts"]`).append(`<option value="${value.id}">${value.name_th}</option>`);
                } else {
                    $(`#form_reg_noncompany [name^="companyTH_subdistricts"]`).append(`<option value="${value.id}">${value.name_en}</option>`);
                }
            });
            $('.selectpicker').selectpicker('refresh');
    ...
    $.ajax({
        ...
        success: function (result) {
            $.each(result, function (key, value) {
                ...
                if (result.lang == 'th') {
                    $(`#form_reg_noncompany [name^="companyTH_districts"]`).append(`<option value="${value.id}">${value.name_th}</option>`);
                } else {
                    $(`#form_reg_noncompany [name^="companyTH_districts"]`).append(`<option value="${value.id}">${value.name_en}</option>`);
                }
            });
            $('.selectpicker').selectpicker('refresh');
            ...
            // store data option to sub_districe
            change_district3($(`[name^="companyTH_districts"]`))
        },
        complete: function() {
            $('.modal-spin').modal('hide');
        }
...
$(`#form_reg_company [name^="contact_province"]`).on('change', function () {
    change_province($(this));
})


/********** On Change amphures อำเภอ ***********/
$(`#form_reg_company [name^="contact_district"]`).on('change', function () {
    change_district($(this));
})

/********** On Change districe ตำบล ***********/
$(`#form_reg_company [name^="contact_subdistrict"]`).on('change', function () {
    var id = $(this).val();
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $(`#form_reg_company [name^="contact_postcode"]`).val(result[0].zip_code);
...
$(".radio_new_adress1").click(function () {
    $(`#form_reg_company [name="state"]`).val('new');
    $(`#form_reg_company [name="contact_province_old"]`).val('').hide();
    $(`#form_reg_company [name="contact_district_old"]`).val('').hide();
    $(`#form_reg_company [name="contact_subdistrict_old"]`).val('').hide();
    $(`#form_reg_company [name="contact_address_old"]`).val('').hide();
    $(`#form_reg_company [name="contact_postcode_old"]`).val('').hide();

    $(`#form_reg_company [name="contact_postcode"]`).show();
    $(`#form_reg_company [name="contact_address"]`).show();
    $(`#form_reg_company [name="contact_province"]`).selectpicker('show');
    $(`#form_reg_company [name="contact_district"]`).selectpicker('show');
    $(`#form_reg_company [name="contact_subdistrict"]`).selectpicker('show');
...
$(".radio_old_adress1").on('click',function() {
    console.log("clicked");
    $(`#form_reg_company [name="state"]`).val('old');
    let company_address = $(`#form_reg_company [name="company_address"]`).val();
    let company_province = $(`#form_reg_company [name="company_province"]`).val();
    let company_district = $(`#form_reg_company [name="company_district"]`).val();
    let company_subdistrict = $(`#form_reg_company [name="company_subdistrict"]`).val();
    let company_postcode = $(`#form_reg_company [name="company_postcode"]`).val();

    $(`#form_reg_company [name="contact_address_old"]`).val(company_address).show();
    $(`#form_reg_company [name="contact_province_old"]`).val(company_province).show();
    $(`#form_reg_company [name="contact_district_old"]`).val(company_district).show();
    $(`#form_reg_company [name="contact_subdistrict_old"]`).val(company_subdistrict).show();
    $(`#form_reg_company [name="contact_postcode_old"]`).val(company_postcode).show();
    
    $(`#form_reg_company [name="contact_address"]`).hide();
    $(`#form_reg_company [name="contact_province"]`).selectpicker('hide');
    $(`#form_reg_company [name="contact_district"]`).selectpicker('hide');
    $(`#form_reg_company [name="contact_subdistrict"]`).selectpicker('hide');
    $(`#form_reg_company [name="contact_postcode"]`).hide();
...
/*const prop_dropdown =()=> {
    let select_province = $("#form_reg_company [name='company_province']").val();
    let option_province = $("#form_reg_company [name='bus[province]'] option");
...
function test(){
    $('.selectpicker').selectpicker('refresh');
    let select_district = $("#form_reg_company [name='company_district']").val();
