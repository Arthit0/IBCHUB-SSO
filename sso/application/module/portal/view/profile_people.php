						...
						<div class="container">
							<div class="form-row">
								...
								<div class="form-group col-sm-4 p-4">
									...
									<small class="form-text text-muted mt-0"><?= $user_data['member_nameTh'] ?>&nbsp;<?= $user_data['member_lastnameTh'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label">ชื่อ-นามสกุล (ภาษาอังกฤษ)</label>
									<small class="form-text text-muted mt-0"><?= $user_data['member_nameEn'] ?>&nbsp;<?= $user_data['member_lastnameEn'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
