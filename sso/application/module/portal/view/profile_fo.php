	...
	<div class="container">
		<div class="profile-container">
			<div class="profile-title">
				<h2 class="contact-title">Personal information </h2>
				...
				<div class="col-sm-12 mb-2">
					<div class="profile-card my-3">
						<div class="profile-card-head">
							<div class="container">
								<div class="profile-card-title"><h4>Personal Information</h4></div>
							</div>
						</div>
						<div class="container">
							<div class="form-row">
								<div class="form-group col-sm-4 p-4">
									<label class="control-label">Passport ID &nbsp;
									</label>
									<small class="form-text text-muted mt-0"><?= $user_data['cid'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label">First Name - Last Name </label>
									<small class="form-text text-muted mt-0"><?= $user_data['member_title'] ?>&nbsp;<?= $user_data['member_nameEn'] ?>&nbsp;<?= $user_data['member_lastnameEn'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
						...
						<div class="container">
							<div class="form-row">
								<div class="form-group col-sm-12 p-4">
									...
									<small class="form-text text-muted mt-0"><?= $user_data['address'] ?></small>
								</div>
							</div>
						</div>
					</div>
