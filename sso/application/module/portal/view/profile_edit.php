		...
		<div class="profile-container">
			...
			<div class="row">
				<div class="col-sm-12 mb-2">
					<form action="" method="post" id="type16_edit">
						<input type="hidden" name="member_id" value="<?= $user_data['member_id'] ?>">
						<input type="hidden" name="status_contact_nationality" value="<?= $user_data['status_contact_nationality'] ?>">
							...
							<div class="container">
								<div class="form-row sso-input p-4">
									<div class="form-group col-sm-6">
										<label class="control-label"><?php echo lang('regis_com_num'); ?>&nbsp;</label>
										<input class="input-sso" type="text" name="cid" id="user1_id" value="<?= $user_data['cid'] ?>" autocomplete="off"
									...
									<div class="form-group col-sm-6 sso-row-input">
										...
										<input type="text" class="input-sso" name="company_nameTh" value="<?= $user_data['company_nameTh'] ?>" placeholder="<?php echo lang('regis_com_name'); ?>" readonly>
									</div>
									<div class="form-group col-sm-6 sso-row-input">
										<label class="control-label"><?php echo lang('regis_com_nameen'); ?></label>
										<input type="text" class=" input-sso" name="company_nameEn" value="<?= $user_data['company_nameEn'] ?>"
									...
									<div class="form-group col-sm-6 sso-row-input">
										<div class="find">
											...
											<input type="text" class=" input-sso postcode postcodeth" name="company_postcode" value="<?= $user_data['company_postcodeTh'] ?>"
									...
									<div class="form-group col-sm-6 sso-row-input">
										<label class="control-label"><?php echo lang('regis_com_province'); ?></label>
											<div class="provi1">
												<input type="text" class=" input-sso" name="company_provinceTh" value="<?= $user_data['company_provinceTh'] ?>" placeholder="<?php echo lang('regis_com_province'); ?>"
												readonly>
											</div>
									</div>
									<div class="form-group col-sm-6 sso-row-input">
										...
										<div class="dis1">
											<input type="text" class=" input-sso" name="company_districtTh" value="<?= $user_data['company_districtTh'] ?>" placeholder="<?php echo lang('regis_com_district'); ?>"
											readonly>
										</div>
										<div class="dis2" style="display:none;">
											<select class="form-control selectpicker sso-dropdown districtth" title="<?php echo lang('regis_com_district'); ?>"
												tabindex="-98" name="companyTH_districts" value="<?= $user_data['company_districtTh'] ?>"  data-live-search="false">
									...
									<div class="form-group col-sm-6 sso-row-input">
										...
										<div class="subdis1">
											<input type="text" class=" input-sso" name="company_subdistrictTh" value="<?= $user_data['company_subdistrictTh'] ?> "placeholder="<?php echo lang('regis_com_subdistrict'); ?>"
											readonly>
										</div>
										<div class="subdis2" style="display:none;">
											<select class="form-control selectpicker sso-dropdown" title="<?php echo lang('regis_com_subdistrict'); ?>" tabindex="-98"
												name="companyTH_subdistricts" value="<?= $user_data['company_subdistrictTh'] ?>" data-live-search="false">
									...
									<div class="form-group col-sm-6 sso-row-input">
										...
										<input type="text" class=" input-sso" name="company_addressTh" value="<?= $user_data['company_addressTh'] ?>" placeholder="<?php echo lang('regis_com_address'); ?>" readonly>
									</div>
									<div class="form-group col-sm-6 sso-row-input">
										<label class="control-label"><?php echo lang('regis_com_addressen'); ?></label>
										<input type="text" class=" input-sso" name="company_addressEn" value="<?= $user_data['company_addressEn'] ?>"
						...
						<div class="profile-card my-3">
							<div class="profile-card-head">
								<div class="container">
									...
									<?php if ($user_data['director_status'] == 2): ?>
									<div class="profile-card-title"><h4><?=  lang('title_director2') ?></h4></div>
								<?php endif ?>
								<?php if ($user_data['director_status'] == 1): ?>
									<div class="profile-card-title"><h4><?= lang('title_director1') ?></h4></div>
								<?php endif ?>
								</div>
							</div>
							<div class="container">
								<div class="form-row sso-input p-4">
									<div class="form-group col-sm-6">
										...
										<input class="input-sso" type="text" value="<?= $user_data['member_cid'] ?>" name="contact_cid" id="user1_id" autocomplete="off" maxlength="13"
									...
									<!-- <div class="form-group col-sm-6 sso-row-input">
										...
										<input type="date" class=" input-sso sso-date-picker" value="<?= $user_data['member_birthday'] ?>" name="member_birthday" >
									</div> -->
									<div class="form-group col-sm-6 sso-row-input">
										<label class="control-label"><?php echo lang('regis_contact_mail'); ?> &nbsp;<span class="text-danger">*</span></label>
										<input type="text" class=" input-sso" value="<?= $user_data['member_email'] ?>" name="member_email" placeholder="<?php echo lang('regis_contact_mail'); ?>">
									</div>
									<div class="form-group col-sm-6 sso-row-input">
										<label class="control-label"><?php echo lang('regis_contact_phone'); ?> &nbsp;<span class="text-danger">*</span></label>
										<div id="tel1">
											<input type="text" class=" input-sso" value="<?= $user_data['member_tel'] ?>" name="contact_tel" maxlength="15"
											placeholder="<?php echo lang('regis_contact_phone'); ?>">
											<input type="hidden" value="<?= empty($user_data['member_tel_country'])?'':$user_data['member_tel_country'] ?>" name="contact_tel_country">
											<input type="hidden" value="<?= empty($user_data['member_tel_code'])?'':$user_data['member_tel_code'] ?>" name="contact_tel_code">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="form-row sso-input card-people-address  card-sm-show-border p-4" id="form_reg_people">
									<div class="find form-row w-100">
										<div class="form-group col-sm-6 sso-row-input">
											...
											<input type="text" class=" input-sso postcode" name="postcode" value="<?= $user_data['contact_postcode'] ?>" data-district="<?= $user_data['contact_district'] ?>" data-subdistrict="<?= $user_data['contact_subdistrict'] ?>" placeholder="<?php echo lang('regis_com_postcode'); ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										...
										<div class="form-group col-sm-6 sso-row-input mb-4">
											...
											<input type="text" class=" input-sso" value="<?= $user_data['contact_address'] ?>" name="addressTh" placeholder="<?php echo lang('regis_com_address'); ?>">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="d-flex justify-content-center align-items-center">
						...
						<?php endif ?>
						<button type="button" data-status_contact_nationality="<?php echo $user_data['status_contact_nationality'] ?>" data-status_email_verify="<?php echo $user_data['status_email_verify'] ?>" data-status_sms_verify="<?php echo $user_data['status_sms_verify'] ?>" data-status_laser_verify="<?php echo $user_data['status_laser_verify'] ?>" data-fname="<?= $user_data['member_nameTh'] ?>" data-lname="<?= $user_data['member_lastnameTh'] ?>" data-contact-title="<?= $user_data['member_title'] ?>" data-birthday="<?= $user_data['member_birthday'] ?>" data-member_type="<?= $user_data['type'] ?>" data-member_email="<?= $user_data['member_email'] ?>" data-member_phone="<?= $user_data['member_tel'] ?>" data-callback="<?= $callback ?>" class="btn btn-profile-submit"><?= lang('home_profile_submit') ?></button>
					</div>
				</div>
			</div>
		</div>
...
<div id="tel3" class="d-none">
	<input type="hidden" class=" input-sso" name="tel" maxlength="15"
	placeholder="<?php echo lang('regis_contact_phone'); ?>">
	<input type="hidden" name="tel_country">
	<input type="hidden" name="tel_code">
</div>
<div id="tel4" class="d-none">
	<input type="hidden" name="contact_director_tel" maxlength="10">
...
<script src="<?php echo BASE_PATH; ?>asset/js/page/portal/type16_edit.js"></script>
...
<script>
	$(document).ready(function () {
		...
		var tel_code = document.querySelector("input[name='contact_tel']");
		var tel_country = document.querySelector("input[name='contact_tel_country']").value;
