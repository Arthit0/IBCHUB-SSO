	...
	<div class="container">
		<div class="profile-container">
			<div class="profile-title">
				<h2 class="contact-title"><?= lang('home_profile_title') ?></h2>
				...
				<div class="col-sm-12 mb-2">
						...
						<div class="container">
							<div class="form-row">
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('regis_com_num') ?></label>
									<small class="form-text text-muted mt-0"><?= $user_data['cid'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('edit_company_Th') ?></label>
									<small class="form-text text-muted mt-0"><?= $user_data['company_nameTh'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('edit_company_En') ?></label>
									<small class="form-text text-muted mt-0"><?= $user_data['company_nameEn'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('regis_com_address') ?></label>
									<small class="form-text text-muted mt-0"><?= $user_data['company_addressTh'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('regis_com_addressen') ?></label>
									<small class="form-text text-muted mt-0"><?= $user_data['company_addressTh'] ?>&nbsp;<?= $user_data['company_subdistrictTh'] ?>&nbsp;<?= $user_data['company_districtTh'] ?>&nbsp;<?= $user_data['company_provinceTh'] ?>&nbsp;<?= $user_data['company_postcodeTh'] ?></small>
								</div>
							</div>
						</div>
					</div>
					<div class="profile-card my-3">
						...
						<div class="container">
							<div class="form-row">
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= $user_data['status_contact_nationality'] == 2?lang('regis_contact_id_fo'): lang('regis_citizen') ?> &nbsp;
									...
									<small class="form-text text-muted mt-0"><?= $user_data['member_cid'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('portal_profilename') ?></label>
									<small class="form-text text-muted mt-0"><?= $user_data['member_title'] ?>&nbsp;<?= $user_data['member_nameTh'] ?>&nbsp;<?= $user_data['member_lastnameTh'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('portal_profilenameEn') ?></label>
								...
								<div class="form-group col-sm-4 p-4">
									<label class="control-label">อีเมล &nbsp;
										...
										<?php else: ?>
											<small>
												<span data-isverify="N" data-member_id="<?= $user_data['member_id'] ?>" data-email="<?= $user_data['member_email'] ?>" data-target="portal" class="is_email_verify text-danger"><i class="fa-solid fa-circle-exclamation"></i></i>&nbsp;Verify</span>
											</small>
										<?php endif ?>
										
									</label>
									<small class="form-text text-muted mt-0"><?= $user_data['member_email'] ?></small>
								</div>
								<div class="form-group col-sm-4 p-4">
									<label class="control-label"><?= lang('portal_profilephone') ?> &nbsp;
										...
										<?php else: ?>
											<small>
												<span data-isverify="N" data-member_id="<?= $user_data['member_id'] ?>" data-tel="<?= $user_data['member_tel'] ?>" data-target="portal" class="is_phone_verify text-danger"><i class="fa-solid fa-circle-exclamation"></i></i>&nbsp;Verify</span>
											</small>
										<?php endif ?>
									</label>
									<small class="form-text text-muted mt-0"><?= $user_data['member_tel'] ?></small>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="container">
							<div class="form-row">
								<div class="form-group col-sm-12 p-4">
									<label class="control-label"><?= lang('regis_com_address') ?></label>
									<small class="form-text text-muted mt-0"><?= $user_data['contact_address'] ?>&nbsp;<?= $user_data['contact_subdistrict'] ?>&nbsp;<?= $user_data['contact_district'] ?>&nbsp;<?= $user_data['contact_province'] ?>&nbsp;<?= $user_data['contact_postcode'] ?></small>
								</div>
							</div>
						</div>
					</div>
