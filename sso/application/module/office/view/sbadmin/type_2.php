<!-- นิติบุคคลต่างชาติ -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="row sso-row">
            <div class="col-3 text-right"><h5>Corporate Name</h5></div>
            <div class="col-1"></div>
            <div class="col-6">
              <input class="sso-input" type="text" name="corporate_name" autocomplete="off" placeholder=""
              value="<?php echo htmlentities($member_type['corporate_name']); ?>">
            </div>
          </div>
          <div class="row sso-row">
            <div class="col-3 text-right"><h5>Country</h5></h5></div>
            <div class="col-1"></div>
            <div class="col-6">
              <input class="sso-input" type="text" name="country" autocomplete="off" placeholder=""
              value="<?php echo htmlentities($member_type['country']); ?>">
            </div>
          </div>
          <div class="row sso-row">
            <div class="col-3 text-right"><h5>Corporate address</h5></div>
            <div class="col-1"></div>
            <div class="col-6">
              <input class="sso-input" type="text" name="address" autocomplete="off" placeholder=""
              value="<?php echo htmlentities($member_type['address']); ?>">
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="row sso-row">
            <div class="col-3 text-right"><h5>Email</h5></div>
            <div class="col-1"></div>
            <div class="col-6">
              <input class="sso-input" type="text" name="email" autocomplete="off" placeholder=""
              value="<?php echo htmlentities($member_type['email']); ?>">
            </div>
          </div>
          ...
          <div class="row sso-row">
            ...
            <div class="col-1"></div>
            <div class="col-6">
              <input class="sso-input" type="text" name="tel" autocomplete="off" placeholder=""
              value="<?php echo htmlentities($member_type['tel']); ?>">
            </div>
          </div>
