      ...
      <div class="container">
            <div class="row d-inline-flex align-items-center mb-2 w-100">
                ...
                <div class="col-sm-4  text-left">
                    <p>ที่อยู่ติดต่อ :</p>
                    <p> <?php  echo (!empty($member_type['addressTh'])) ?  htmlentities($member_type['addressTh']) :   "-";
                        echo (!empty($member_type['subdistrictTh']))? htmlentities(' ต.'.$member_type['subdistrictTh']) : " ต.-";
                        echo (!empty($member_type['districtTh']))? htmlentities(' อ.'.$member_type['districtTh']) : " อ.-";
                        echo (!empty($member_type['provinceTh']))? htmlentities(' จ.'.$member_type['provinceTh']) : " จ.-";
                        echo (!empty($member_type['postcode']))? htmlentities(' '.$member_type['postcode']) : " ";
                     ?> 
                    </p>
                </div>
                <div class="col-sm-4  text-left">
                    <p>ที่อยู่ติดต่อ(ภาษาอังกฤษ) :</p>
                    <p> <?php  echo (!empty($member_type['addressEn'])) ?  htmlentities($member_type['addressEn']) :   "-";
                        echo (!empty($member_type['subdistrictEn']))? htmlentities(' ต.'.$member_type['subdistrictEn']) : " ต.-";
                        echo (!empty($member_type['districtEn']))? htmlentities(' อ.'.$member_type['districtEn']) : " อ.-";
                        echo (!empty($member_type['provinceEn']))? htmlentities(' จ.'.$member_type['provinceEn']) : " จ.-";
                        echo (!empty($member_type['postcode']))? htmlentities(' '.$member_type['postcode']) : " ";
                     ?> 
                    </p>
                </div>
