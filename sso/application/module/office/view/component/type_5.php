          ...
          <div class="col-12">
            <div class="row sso-row">
              ...
              <div class="col-6">
                ...
                placeholder="รหัส SSO (SSO ID)" value="<?php echo $member['sso_id']; ?>" readonly>
              </div>
            </div>
            <div class="row sso-row">
            ...
            <div class="row sso-row">
              ...
              <div class="col-6">
                ...
                placeholder="เลขนิติบุคคล (Username)" value="<?php echo $member['cid']; ?>" required>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <!--<div class="row sso-row">
            ...
            <div class="col-6">
              ...
              placeholder="First name" value="<?php //echo $member_type['member_nameEn']; ?>">
            </div>
          </div>
          <div class="row sso-row">
            ...
            <div class="col-6">
              ...
              placeholder="Last name" value="<?php //echo $member_type['member_lastnameEn']; ?>">
            </div>
          </div>
          <div class="row sso-row">
            ...
            <div class="col-6">
              ...
              placeholder="เลขบัตรประชาชน" value="<?php //echo $member['cid']; ?>">
            </div>
          </div>-->
          <div class="row sso-row">
