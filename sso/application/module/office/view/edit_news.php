...
<div class="content-wrapper">
  ...
  <div class="content-header">
    ...
    <form id="form_edit_news" action="" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="row sso-row d-inline-flex align-items-center w-100">
                ...
                <div class="col-sm-6">
                  <input class="form-control" type="text" name="n_title" value="<?= $data['n_title'] ?>" autocomplete="off" placeholder="หัวข้อข่าว/แจ้งเตือน" required>
                </div>
              </div>
              <div class="row sso-row d-inline-flex align-items-center w-100">
                <div class="col-sm-3 text-right"><h5 class="mb-0 ibm-m _f16">รายละเอียด</h5></div>
                <div class="col-sm-6">
                  <textarea class="form-control" name="n_des" id="n_des" cols="30" rows="10"><?= $data['n_des'] ?></textarea>
                </div>
              </div>
              <div class="row sso-row d-inline-flex align-items-center w-100">
                <div class="col-sm-3 text-right"><h5 class="mb-0 ibm-m _f16">วันที่เผยแพร่</h5></div>
                <div class="col-sm-6">
                  <input class="form-control" type="date" value="<?= $data['publicdate'] ?>" name="publicdate" autocomplete="off" placeholder="DD/MM/YYYY" required>
                </div>
              </div>
            </div>
          </div>
