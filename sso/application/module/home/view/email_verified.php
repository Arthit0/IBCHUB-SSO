		...
		<div class="container-fluid d-flex flex-column justify-content-center align-items-center h-100">
			<?php if ($res['res_code'] == "00"): ?>
				<div class="d-flex flex-column justify-content-center w-100">
					...
					<a href="<?php echo BASE_PATH . _INDEX; ?>home/login" class="btn btn-login w-50">เข้าสู่ระบบ</a>
				</div>
			<?php else: ?>
				<div class="d-flex flex-column justify-content-center w-100">
					...
					<div class="btn-group">
						...
						<a href="<?php echo BASE_PATH . _INDEX; ?>home/login" class="btn btn-login">เข้าสู่ระบบ</a>
					</div>
				</div>
			<?php endif ?>
