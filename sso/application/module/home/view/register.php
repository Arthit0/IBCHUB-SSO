...
<div class="row">
	...
	<div class="col-md-8 col-md-none" style="height:100vh;overflow:hidden;overflow-y:auto;">
		<nav class="navbar navbar-light ">
			<div class="justify-content-start pointer">
				<a href="<?php echo BASE_PATH . _INDEX ?>auth/" class="back-login text-dark">
						...
						<div class="tab-pane fade show active" id="pills-company" role="tabpanel" aria-labelledby="company-tab">
							<form action="#" onsubmit="return false" id="<?php echo $form_reg_company = 'form_reg_company'; ?>" autocomplete="off" class="form-horizontal">
								...
								<div class="form-row sso-input">
									<div class="form-group col-sm-6 loader_input">
										...
										<div class="regis-com-check">
											...
											<button class="btn btn-primary regis-com-check-btn ck_dbd" type="button"><?php echo lang('regis_check_btn') ?></button> 
										</div>
								...
								<div class="form-row sso-input">
											...
											<div class="row">
												<div class="col-4 col-sm-5 col-md-4 col-lg-3">
													<label class="sso-radio pointer"> <?php echo lang('regis_com_checkbox1'); ?>
														<input class="ck_address " type="radio" name="ck_director_type" checked value="1" placeholder="<?php echo lang('regis_com_checkbox1'); ?>">
														<span class="checkmark"></span>
													</label>
												</div>
												<div class="col-8 col-sm-7 col-md-8 col-lg-7">
													<label class="sso-radio pointer old_adress1"> <?php echo lang('regis_com_checkbox2'); ?>
														<input class="ck_address " type="radio" name="ck_director_type" value="2" placeholder="<?php echo lang('regis_com_checkbox2'); ?>">
														<span class="checkmark"></span>
													</label>
												</div>
											</div>
									...
									<div class="form-group col-sm-6 sso-row-input loader_input">
										<!-- <span id="text-use2" style="display:none;"><?php echo lang('regis_com_taxid'); ?></span> -->
										<div class="d-flex justify-content-between">
								...
								<div class="regis-header mt-4">
									<h4 class="mitr-r"><span><?= lang('regis_com_header') ?></span></h4>
								</div>
								<div class="form-row sso-input">
									<div class="form-group col-sm-12">
										<div class="sso-row-input">
											...
											<div class="row">
												<div class="col-sm-6">
													<label class="sso-radio pointer"> <?php echo lang('regis_email_verify_checkbox1'); ?>
														<input class="" type="radio" name="ck_verify" value="0" placeholder="<?php echo lang('regis_email_verify_checkbox1'); ?>"checked>
														<span class="checkmark"></span>
													</label>
												</div>
												<div class="col-sm-6">
													<label class="sso-radio pointer"> <?php echo lang('regis_sms_verify_checkbox1'); ?>
														<input class="" type="radio" name="ck_verify" value="1" placeholder="<?php echo lang('regis_sms_verify_checkbox1'); ?>">
														<span class="checkmark"></span>
													</label>
												</div>
											</div>
								...
								<div class="form-group col-sm-6">
									<div class="btn  submitform  btn-con-reg"
								...
								<div class="row sso-radio-container">
									<div class="col-sm-12 col-md-6 col-lg-6 d-flex">
										<label class="sso-radio pointer ">
											<div class="" href="<?php echo BASE_PATH . _INDEX ?>auth/forget">
												<b class="text-white">Corporate ID</b>
											</div>
									...
									<div class="col-sm-12 col-md-6 col-lg-6 d-flex">
										<label class="sso-radio pointer ">
											<div class="" href="<?php echo BASE_PATH . _INDEX ?>auth/forget">
												<b class="text-white">Passport ID</b>
											</div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="border-radius: 8px !important;">
      ...
      <div class="modal-footer d-flex justify-content-center" style="border-top: 1px solid #8A919E;">
      	...
      	<button type="button" class="btn ck-citizen-laser-btn">ตรวจสอบข้อมูล</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="border-radius: 8px !important;">
      <div class="modal-header " style="border-bottom: 1px solid #8A919E;">
        <h5 class="modal-title mitr-r" style="font-size: 18px;"><?php echo lang('laser_modal_title') ?> นิติ</h5>
