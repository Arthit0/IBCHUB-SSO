  ...
  <div class="content-header">
    <div class="container-fluid">
       ...
       <div class="row">
            ...
            <h2 style="color:#629cc1">User List > Edit Cancel to Member</h2>
            </div>
            <div class="col-sm-6 text-right">
            <a href="<?php echo BASE_PATH; ?>office/edit_text" class="btn sso-btn-add"><i class="fa fa-plus mx-2 my-1"></i>แก้ไขเนื้อหา</a>
            </div><!-- /.col -->
       </div>
