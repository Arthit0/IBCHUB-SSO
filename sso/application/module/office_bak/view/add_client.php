    ...
    <form id="form_add_client" action="" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-6 text-left">
          <h2 style="color:#629cc1">Clients List > Add Client</h2>
        </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="row sso-row">
              ...
              <div class="col-1"></div>
              <div class="col-6">
                <input class="sso-input" type="text" name="mc_name" autocomplete="off" placeholder="Client Name" required>
              </div>
            </div>
            <div class="row sso-row">
              ...
              <div class="col-1"></div>
              <div class="col-6">
                <input class="sso-input" type="text" name="client_id" autocomplete="off" placeholder="Client ID" 
                required readonly value = "<?php echo $data; ?>">
              </div>
            </div>
            <div class="row sso-row">
              ...
              <div class="col-1"></div>
              <div class="col-6">
                <input class="sso-input" type="text" name="redirect_uri" autocomplete="off" placeholder="URL for Reply">
              </div>
            </div>
            <div class="row sso-row">
              ...
              <div class="col-6">
                ...
                <select class="form-control selectpicker sso-dropdown sso-dropdown-edit" title="สถานะ" tabindex="-98" name="status">
                  ...
                  <option value="1" selected>เปิดการเชื่อมต่อ</option>
                </select>
              </div>
            </div>
