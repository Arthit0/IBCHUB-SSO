...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <h2 style="color:#629cc1">Client List</h2>
        </div><!-- /.col -->
        <div class="col-sm-6 text-right">
          <a href="<?php echo BASE_PATH; ?>office/add_client" class="btn sso-btn-add"><i class="fa fa-plus mx-2 my-1"></i>เพิ่มผู้เชื่อมต่อ</a>
        </div><!-- /.col -->
      </div><!-- /.row -->
            ...
            <table class="table table-striped table-bordered sso-table"
              ...
              <thead>
                <tr class="text-center">
                  ...
                  <th data-field="td6" scope="col" data-align="center"></th>
                </tr>
              </thead>
            </table>
