          ...
          <div class="attach-content-container">
            <div class="row">
              ...
              <div class="col-12 text-center my-4">
                <a id="back-to-login" class="mitr-l _f16" href="<?php echo BASE_PATH . _INDEX; ?>auth?response_type=<?php echo $_GET['response_type'] ?>&client_id=<?php echo $_GET['client_id'] ?>&redirect_uri=<?php echo $_GET['redirect_uri'] ?>" type="button" role="button"><?php echo lang('attach_back_login') ?></a>
              </div>
            </div>
          </div>
        </div>
