	...
	<div class="col-md-8 col-md-none pl-0">
		...
		<div class="container-fluid d-flex flex-column justify-content-center align-items-center h-100">
			<div class="d-flex flex-column justify-content-center w-100">
				...
				<div class="btn-group">
					<a href="<?php echo BASE_PATH . _INDEX; ?>auth?response_type=token&client_id=SS8663835&redirect_uri=https://sso-uat.ditp.go.th/sso/portal/ck_portal&state=1" class="btn btn-login mitr-r">เข้าสู่ระบบ</a>
				</div>
			</div>
		</div>
	</div>
