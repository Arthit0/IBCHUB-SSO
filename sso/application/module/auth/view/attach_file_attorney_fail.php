            ...
            <div class="row">
              ...
              <div class="col-12">
                <p class="text-center text-white mitr-l _f14">
                  ...
                  โทร : 02507 7999 | e-mail : 1169@ditp.go.thfail
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-3 px-0">
                <div class="example-image-container">
                  ...
                  <p class="mb-0 mitr-l _f16 pt-2"><?php echo lang('attach_example') ?></p>
                </div>
              </div>
                ...
                <div class="row  flex-column">
                  <div class="col-12 pr-0">
                    ...
                    <form id="form_attach_file" enctype="multipart/form-data" method="POST">
                      <input type="hidden" name="power-attorney-file" value="<?php echo $file['files1']['status'] ?>" id="power-attorney-file">
                   ...
                   <div class="col-12" id="files-name">
                    <!-- <?php 
                      if ($file[0]['status'] == 1 && $file[0]['type_file'] == 1): ?>
                      <div class="approved-file"><i class="fa-regular fa-circle-check"></i>&nbsp;<a class="mitr-r _f16" href="/sso/asset/attach/<?php echo $file[0]['member_id'] ?>/<?php echo $file[0]['attachment_file_name'] ?>" target="_blank"><?php echo $file[0]['attachment'] ?></a></div>
                    <?php endif ?>
                    <?php if ($file[0]['status'] == 2 && $file[0]['type_file'] == 1): ?>
                      <div class="rejected-file"><i class="fa-regular fa-circle-xmark"></i>&nbsp;<a class="mitr-r _f16" href="/sso/asset/attach/<?php echo $file[0]['member_id'] ?>/<?php echo $file[0]['attachment_file_name'] ?>" target="_blank"><?php echo $file[0]['attachment'] ?></a></div>
                    <?php endif ?> -->
                      <div class="<?php echo $file['files1']['divclass'] ?>"><i class="<?php echo $file['files1']['iclass'] ?>"></i>&nbsp;<a class="<?php echo $file['files1']['aclass'] ?>" href="<?php echo $file['files1']['href'] ?>" target="_blank"><?php echo $file['files1']['attachment'] ?></a></div>
                  </div>
                </div>
              </div>
              <div class="col-12 mb-2 d-inline-flex justify-content-between align-items-center">
              ...
              <div class="col-9 px-0 mt-4">
                <div class="row  flex-column">
                  <div class="col-12 pr-0">
                    <!--begin::Form-->
                    <form id="form_attach_file" enctype="multipart/form-data" method="POST">
                      <input type="hidden" name="idcard-file" value="<?php echo $file['files2']['status'] ?>" id="idcard-file">
                      <div class="form-group col-sm-12 pr-0">
                         <div id="dropzone2" class="dropzone shadow"></div>
                      </div>
                  </div>
                  <div class="col-12" id="files-name2">
                    <!-- <?php if ($file[1]['status'] == 1 && $file[1]['type_file'] == 2): ?>
                      <div class="approved-file"><i class="fa-regular fa-circle-check"></i>&nbsp;<a class="mitr-r _f16" href="/sso/asset/attach/<?php echo $file[1]['member_id'] ?>/<?php echo $file[1]['attachment_file_name'] ?>" target="_blank"><?php echo $file[1]['attachment'] ?></a></div>
                    <?php endif ?>
                    <?php if ($file[1]['status'] == 2 && $file[1]['type_file'] == 2): ?>
                      <div class="rejected-file"><i class="fa-regular fa-circle-xmark"></i>&nbsp;<a class="mitr-r _f16" href="/sso/asset/attach/<?php echo $file[1]['member_id'] ?>/<?php echo $file[1]['attachment_file_name'] ?>" target="_blank"><?php echo $file[1]['attachment'] ?></a></div>
                    <?php endif ?> -->
                     <input type="hidden" id="member_id" value="<?php echo htmlentities($user['member_id']); ?>">
                    <div class="<?php echo $file['files2']['divclass'] ?>"><i class="<?php echo $file['files2']['iclass'] ?>"></i>&nbsp;<a class="<?php echo $file['files2']['aclass'] ?>" href="<?php echo $file['files2']['href'] ?>" target="_blank"><?php echo $file['files2']['attachment'] ?></a></div>
                  </div>
                </div>
              </div>
...
<script>
  ...
  var power = $("#power-attorney-file").val();
  var idcard = $("#idcard-file").val();
  frm.addEventListener("submit", function(e) {
      // Make sure that the form isn't actually being sent.
      e.preventDefault();
      e.stopPropagation();

       if ((power == 2 && myDropzone.files != "") && (idcard == 2 && myDropzone2.files != "")) {
            console.log('submit');
          $('.modal-spin').modal('show');
          if (power == 2 && idcard == 2) {
            myDropzone.processQueue();
            myDropzone2.processQueue();
          } else if ((power == 1 || !power) && idcard == 2 ) {
            if (!power) {
              myDropzone.processQueue();
              myDropzone2.processQueue();
            } else {
            ...
            // myDropzone2.processQueue();
          } else if (power == 2 && (idcard == 1 || !idcard) ) {
            if (!idcard) {
              myDropzone.processQueue();
              myDropzone2.processQueue();
            } else {
